        ...
        <div className="flex h-screen flex-col items-center justify-center">
            ...
            <div>
                <Link to={"/api/auth/admin/signup"}>
                    <button className={"mt-3 focus:outline-0 shadow-sm border-1 border-green-400 rounded py-3 px-5 text-lg text-green-500 hover:bg-green-500 hover:text-white hover:shadow-none">Coordinator</button>
                </Link>
