        ...
        <div className="flex h-screen flex-col items-center justify-center">
            ...
            <div className="my-3">
                <Link to={"/api/auth/admin/signup"}>
                    <button 
                    className="focus:outline-0 hover:shadow border-1 border-green-400 rounded py-3 px-5 text-lg text-black font-medium leading-loose hover:bg-green-500 hover:text-white hover:shadow-none">
                    Coordinator</button>
                </Link>
