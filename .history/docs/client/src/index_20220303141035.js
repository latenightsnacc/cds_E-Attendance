...
ReactDOM.render(
  <React.StrictMode>
    ...
    <Routes>
      ...
      <Route path='/api/dashboard/member/:statecode' element={(
        <ProtectedRoute>
          <Member/>
        </ProtectedRoute>
      )} />
      <Route path='/api/dashboard/member/:statecode/attendance' element={(
        <ProtectedRoute>
          <MemberAttendance/>
        </ProtectedRoute>
      )} />
      <Route path='/api/dashboard/member/:statecode/dues' element={(
        <ProtectedRoute>
          <MemberDues/>
        </ProtectedRoute>
      )} />
      <Route path='/api/dashboard/member/:statecode/profile' element={(
        <ProtectedRoute>
          <MemberDues/>
        </ProtectedRoute>
      )} />
