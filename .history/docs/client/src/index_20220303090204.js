...
import MemberAttendance from './dashboard/'
  ...
  <React.StrictMode>
    <Router>
      <Routes>
        ...
        <Route path='/api/dashboard/member/:id/attendance' element={<Member />} />
        <Route path='/api/dashboard/member/:id/dues' element={<Member />} />
        <Route path='/api/dashboard/member/:id/profile' element={<Member />} />
      </Routes>
    </Router>
