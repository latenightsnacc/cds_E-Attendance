...
const AdminRegister = () => {
    ...
    const handleInputChange = event => {
        ...
        setCoordinator({...coordinator, 
            firstname: event.target.value.e,
            surname: event.target.value.
            cdsGroup:event.target.value.,
            lga:event.target.valu         passport:event.target.value.,
            email:event.target.value.           role: event.target.value          state: event.target.value      });
    }
