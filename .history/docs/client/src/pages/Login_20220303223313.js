            ...
            <span className="text-green-500 font-semibold capitalize">CDS E-attendance</span>
              ...
              <form  className="bg-white sm:shadow-md rounded px-8 pt-6 pb-8 mb-4">
                ...
                <div className="flex w-full flex-col">
                  ...
                  <button onClick={handleLogin} className="bg-transparent hover:bg-green-700 text-bl font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline" type="submit" disabled={loading} >
