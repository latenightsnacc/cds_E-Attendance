...
import {user, dispatch, reducer, initialState } from "../auth/index.context"
        ...
        <Container>
            ...
            {USE}
            {
                ...
                <div className="flex w-full flex-col">
                    ...
                    <button id="loginBtn" onClick={() => dispatch({type: 'LOGIN'})}  disabled={loading} className="bg-transparent hover:bg-transparent text-black font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline" type="submit">
