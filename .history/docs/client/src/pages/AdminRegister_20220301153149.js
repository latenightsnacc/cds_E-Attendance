...
const AdminRegister = () => {
    ...
    const createProfile = (e) => {
        ...
        const data = {
            ...
            surname: coordinator.firstname,
            cdsGroup:coordinator.firstname,
            lga:coordinator.firstname,
            email:coordinator.firstname,
            role: coordinator.firstname,
            state:coordinator.firstname
            } 
        try{
