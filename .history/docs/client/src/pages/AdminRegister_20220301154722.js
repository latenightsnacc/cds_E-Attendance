...
const AdminRegister = () => {
    ...
    const handleInputChange = event => {
        ...
        setCoordinator({...coordinator, 
            firstname: event.target.value.firste,
            surname: event.target.value.surna
            cdsGroup:event.target.value.cdsGr,
            lga:event.target.value.lga         passport:event.target.value.passw,
            email:event.target.value.email           role: event.target.value.role          state: event.target.value.stat      });
    }
