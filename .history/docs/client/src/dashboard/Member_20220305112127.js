                ...
                <div className="flex flex-row items-center justify-center">
                    ...
                    <div className="ml-5 md:ml-10 ">
                        ...
                        <div className="flex flex-col text-xs text-gray-700 md:text-sm lg:text-base">
                            <span className="font-medium">Statecode: {user.firstname}</span>
                            <span className="my-1 font-medium text-green-500">CDS Group: {user.firstname}</span>
                            <span className="mb-1 font-medium text-gray-400">Role: {user.firstname}</span>
