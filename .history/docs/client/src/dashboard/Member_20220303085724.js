               ...
               <Container>
                <div className="flex flex-row items-center justify-center">
                    ...
                    <div className="ml-5 md:ml-10 ">
                        <h1 className="leading-7 font-medium  md:text-2xl mb-1">Hello, {corper.firstname}</h1>
                        <div className="flex flex-col text-xs text-gray-700 md:text-sm lg:text-base">
                            <span className="font-medium">Statecode: {corper.statecode}</span>
                            <span className="my-1 font-medium text-green-500">CDS Group: {corper.cdsGroup}</span>
                            <span className="my-1 font-medium text-green-500">Role: {corper.cdsGroup}</span>
