                ...
                <div className="flex flex-row items-center justify-center">
                    ...
                    <div className="ml-5 md:ml-10 ">
                        ...
                        <div className="flex flex-col text-xs text-gray-700 md:text-sm lg:text-base">
                            ...
                            <span className="my-1 font-medium text-green-500">CDS Group: {corper.user.cdsGroup}</span>
                            <span className="mb-1 font-medium text-gray-400">Role: {corper.user.roles}</span>
