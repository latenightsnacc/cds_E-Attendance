...
if(url.indexOf("/api/auth/signin") !== -1 || document.URL.indexOf("/api/auth/signup") !== -1 || document.URL.indexOf("/api/auth/admin/signup") !== -1 || document.URL.indexOf("/api/auth/admin/signin") !== -1 || document.URL.indexOf("/start") !== -1){
    //do nothing
}else{
