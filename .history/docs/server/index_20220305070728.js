...
app.post("/api/auth/signup", async (req, res) => {
    try{
        ...
        const newCorper = await db.insertCorper(firstname,surname,batch,statecode,cdsGroup,lga,ppa,email,phoneNo,profilePic,password,status,roles,state).then(corper)
